               ...
               DO O1 = 1, NSTOKES
                  DO O2 = 1, NSTOKES
                     ...
                     ELSE IF ( COSSIN_MASK(OM) .EQ. 3 ) THEN
                        L_BRDF_F(OM,I,J) = - HELPS * DOT_PRODUCT(BRDFUNC(OM,I,J,1:NK),BRDF_SINAZMFAC(1:NK))
                     ENDIF
if (isnan(L_BRDF_F(OM,I,J))) Then 
print*,'hi ', COSSIN_MASK(OM), I,J, NK,L_BRDF_F(OM,I,J)
print*, '------'
print*, BRDFUNC(OM,I,J,1:NK)
endif
                  ENDDO
               ENDDO
!  End Replacement code ---------------------------------
