...
!  Auxiliary
      ...
      PUBLIC :: LAMBERTIAN_VFUNCTION,     &
                ...
                SNOWRTSMODEL_VFUNCTION,   &    ! Version 2.8.5, 2/28/22
...
!      COXMUNK_VKERNEL(4) = Z2
!      COXMUNK_VKERNEL(5) = Z2_SQ_M1
...
!
      ...
      SUBROUTINE SNOWRTSMODEL_VFUNCTION  &
            ( MAXPARS, NPARS, PARS, NSSQ, XJ, SXJ, XI, SXI, PHI, CPHI, SKPHI, &
              SNOWRTSMODEL_VKERNEL )
...
!      cosxi =  cos ( scatang * DEG_TO_RAD )   ! Xiong
      FFunc = cosxi * exp ( - cosxi )

!  P-function

      PFunc = P1 * Exp ( - Q1 * Scatang ) + P2 * Exp (- Q2 * Scatang )
!      PFunc = P1 * Exp ( - Q1 * phasang ) + P2 * Exp (- Q2 * phasang )    ! Xiong
...
!print*,scatang, FFunc
!print*,R0,R1,R2
!print*,SNOWRTSMODEL_VKERNEL(1)
!pause
!  Done

      RETURN
      END SUBROUTINE SNOWRTSMODEL_VFUNCTION
