...
!  12/20/22. Version 2.8.3. (mick)
!  ========================

!      1. Converted remaining water-leaving radiance calculations to double
!         precision ( Interpolate_fOQ_BS1, Interpolate_fOQ_BS2,
!         Interpolate_fOQ_BS3, Interpolate_fOQ_BSF, WhiteCap_Reflectance)
...
!  Help
   ...
   real(fpk) :: help1, SZA_cosines(Maxszas)
...
!  7/7/21. Avoid this calculation for AOS model inputs. Set to 1.34.
   ...
   if ( AOS_MODEL .ge. 2 .and. AOS_MODEL .le. 4 ) then
      Refrac_R = 1.34_fpk ; Refrac_I = 0.0_fpk
   else
...
!    -- R. Spurr and A. Sayer, 11-12 April 2018.  PATCH, Add Mu0 factor
      ...
      f=0.6279_fpk - (0.2227_fpk*eta) - (0.0513_fpk*eta*eta) + (0.2465_fpk*eta -0.3119_fpk)*SZA_cosines(J)
...
! Applied Optics, March 1973, Vol. 12,  No. 3, pp. 555-563
       ...
       data twl/&
        0.250_fpk,0.275_fpk,0.300_fpk,0.325_fpk,0.345_fpk,0.375_fpk,0.400_fpk,0.425_fpk,0.445_fpk,0.475_fpk,&
        0.500_fpk,0.525_fpk,0.550_fpk,0.575_fpk,0.600_fpk,0.625_fpk,0.650_fpk,0.675_fpk,0.700_fpk,0.725_fpk,&
        0.750_fpk,0.775_fpk,0.800_fpk,0.825_fpk,0.850_fpk,0.875_fpk,0.900_fpk,0.925_fpk,0.950_fpk,0.975_fpk,&
        1.000_fpk,1.200_fpk,1.400_fpk,1.600_fpk,1.800_fpk,2.000_fpk,2.200_fpk,2.400_fpk,2.600_fpk,2.650_fpk,&
        2.700_fpk,2.750_fpk,2.800_fpk,2.850_fpk,2.900_fpk,2.950_fpk,3.000_fpk,3.050_fpk,3.100_fpk,3.150_fpk,&
        3.200_fpk,3.250_fpk,3.300_fpk,3.350_fpk,3.400_fpk,3.450_fpk,3.500_fpk,3.600_fpk,3.700_fpk,3.800_fpk,&
        3.900_fpk,4.000_fpk/

        data tnr/&
        1.362_fpk,1.354_fpk,1.349_fpk,1.346_fpk,1.343_fpk,1.341_fpk,1.339_fpk,1.338_fpk,1.337_fpk,1.336_fpk,&
        1.335_fpk,1.334_fpk,1.333_fpk,1.333_fpk,1.332_fpk,1.332_fpk,1.331_fpk,1.331_fpk,1.331_fpk,1.330_fpk,&
        1.330_fpk,1.330_fpk,1.329_fpk,1.329_fpk,1.329_fpk,1.328_fpk,1.328_fpk,1.328_fpk,1.327_fpk,1.327_fpk,&
        1.327_fpk,1.324_fpk,1.321_fpk,1.317_fpk,1.312_fpk,1.306_fpk,1.296_fpk,1.279_fpk,1.242_fpk,1.219_fpk,&
        1.188_fpk,1.157_fpk,1.142_fpk,1.149_fpk,1.201_fpk,1.292_fpk,1.371_fpk,1.426_fpk,1.467_fpk,1.483_fpk,&
        1.478_fpk,1.467_fpk,1.450_fpk,1.432_fpk,1.420_fpk,1.410_fpk,1.400_fpk,1.385_fpk,1.374_fpk,1.364_fpk,&
        1.357_fpk,1.351_fpk/

        data tni/&
        3.35E-08_fpk,2.35E-08_fpk,1.60E-08_fpk,1.08E-08_fpk,6.50E-09_fpk,&
        3.50E-09_fpk,1.86E-09_fpk,1.30E-09_fpk,1.02E-09_fpk,9.35E-10_fpk,&
        1.00E-09_fpk,1.32E-09_fpk,1.96E-09_fpk,3.60E-09_fpk,1.09E-08_fpk,&
        1.39E-08_fpk,1.64E-08_fpk,2.23E-08_fpk,3.35E-08_fpk,9.15E-08_fpk,&
        1.56E-07_fpk,1.48E-07_fpk,1.25E-07_fpk,1.82E-07_fpk,2.93E-07_fpk,&
        3.91E-07_fpk,4.86E-07_fpk,1.06E-06_fpk,2.93E-06_fpk,3.48E-06_fpk,&
        2.89E-06_fpk,9.89E-06_fpk,1.38E-04_fpk,8.55E-05_fpk,1.15E-04_fpk,&
        1.10E-03_fpk,2.89E-04_fpk,9.56E-04_fpk,3.17E-03_fpk,6.70E-03_fpk,&
        1.90E-02_fpk,5.90E-02_fpk,1.15E-01_fpk,1.85E-01_fpk,2.68E-01_fpk,&
        2.98E-01_fpk,2.72E-01_fpk,2.40E-01_fpk,1.92E-01_fpk,1.35E-01_fpk,&
        9.24E-02_fpk,6.10E-02_fpk,3.68E-02_fpk,2.61E-02_fpk,1.95E-02_fpk,&
        1.32E-02_fpk,9.40E-03_fpk,5.15E-03_fpk,3.60E-03_fpk,3.40E-03_fpk,&
        3.80E-03_fpk,4.60E-03_fpk/
...
!        N.J., 1942, p 173.
        ...
        nrc=0.006_fpk
        nic=0.000_fpk
        nr=nr+nrc*(xsal/34.3_fpk)
        ni=ni+nic*(xsal/34.3_fpk)
...
! Absorption/scattering terms, and parameters for calculation of f
      ...
      real(fpk) vas_chl_a,vas_chl_b,lee_chl_a,lee_chl_b,a_440,Loga_440
...
! 5/9/22. Additional variables for smoothing the data sets at 400 nm
!       real(fpk) vas_a_lim, lee_a_lim, aph400, aph400_vas, aph400_lee

!  8/4/22. Additional Variables for the Chlorophyll absorption

      logical   :: trawl, Gradfix
      integer   :: wc,wv1,wv2,wl1,wl2
      real(fpk) :: fv1, fv2, fl1, fl2, wavdiff, LimWav1, LimWav2
      real(fpk) :: x, xsq, y1, y2, g1, g2, acon, bcon, ccon, dcon
      real(fpk) :: d_vas_chl_a,d_vas_chl_b,d_lee_chl_a,d_lee_chl_b
...
!  Cholorphyll Absoprtion data
!  ===========================

!  Arrays

      real(fpk) :: vasilkov_wavs(11),vasilkov_chl_coeff_a(11),vasilkov_chl_coeff_b(11)
      real(fpk) :: lee_wavs(33),lee_chl_coeff_a(33),lee_chl_coeff_b(33)
...
! Note that this does lead to a discontinuity in predicted reflectance at 400 nm for some geometries and Chl concentrations.
      ...
      data vasilkov_wavs/&
       300.0_fpk,310.0_fpk,320.0_fpk,330.0_fpk,340.0_fpk,350.0_fpk,360.0_fpk,370.0_fpk,380.0_fpk,390.0_fpk,400.0_fpk/
...
! See Table 2 and Equation 12 of Lee et al (1998), Applied Optics 37(27), 6329-6338.
      ...
      data Lee_wavs/&
       400.0_fpk,410.0_fpk,420.0_fpk,430.0_fpk,440.0_fpk,450.0_fpk,460.0_fpk,470.0_fpk,480.0_fpk,490.0_fpk,&
       500.0_fpk,510.0_fpk,520.0_fpk,530.0_fpk,540.0_fpk,550.0_fpk,560.0_fpk,570.0_fpk,580.0_fpk,590.0_fpk,&
       600.0_fpk,610.0_fpk,620.0_fpk,630.0_fpk,640.0_fpk,650.0_fpk,660.0_fpk,670.0_fpk,680.0_fpk,690.0_fpk,&
       700.0_fpk,710.0_fpk,720.0_fpk/
...
!  ==> 2 and 3 are pure water; 4 has hydrosols. Use double precision for wavelengths
      ...
      if ( AOS_MODEL.eq.2 .or. AOS_MODEL.eq.3 ) then
         if ( abs((wl/0.35_fpk)-1.0_fpk).lt.1.0e-12_fpk) then
            a_tot = 0.0204_fpk ; b_wat = 0.0134_fpk ; b_tot = b_wat 
         else if ( abs((wl/0.45_fpk)-1.0_fpk).lt.1.0e-12_fpk) then
            a_tot = 0.0092_fpk ; b_wat = 0.0045_fpk ; b_tot = b_wat
         else if ( abs((wl/0.55_fpk)-1.0_fpk).lt.1.0e-12_fpk) then
            a_tot = 0.0565_fpk ; b_wat = 0.0019_fpk ; b_tot = b_wat
         else if ( abs((wl/0.65_fpk)-1.0_fpk).lt.1.0e-12_fpk) then
...
!  8/4/22. Completely rewritten to smooth out discontinuity with Cubic polynomials

!   Wavelength limit 1 = 390 nm
!   Wavelength limit 2 = 410 nm

      LimWav1 = 390.0_fpk
      LimWav2 = 410.0_fpk
      WavDiff = 0.1_fpk
      Gradfix = (LimWav1.ne.LimWav2)
...
!  1. If the wavelength is  <  Wavlim_1, use Vasilkov et al (AO, 2005) to get a_ph, for wavelengths 300 nm or larger
!         ** Use 300 nm value for wavelengths < 300 nm.

!  2. If the wavelength is >/= Wavlim 2, use Lee et al (1998) data     to get a_ph, for wavelengths 720 nm or smaller
!         ** Use 720 nm value for wavelengths > 720 nm.( This has a minor influence because water absorption dominates here)

!  3. If the wavelength is  >/= Wavlim_1 and < Wavlim_2, fit a Cubic function to get a_ph (R. Spurr, August 2022)
!         -- This will not be done if Wavlim_1 = Wavlim_2 = 400 nm, Then we preserve discontinuity

!  Below 300 nm
!  ------------

       if ( Wavelength .le. 300.0_fpk ) then

         vas_chl_a=vasilkov_chl_coeff_a(1)
         vas_chl_b=vasilkov_chl_coeff_b(1)
         a_chl = vas_chl_a*(C**(-vas_chl_b))
         a_ph  = C * a_chl
!         da_ph = a_chl*(1.0_fpk-vas_chl_b)

!  Between 300 nm and up to Wavlim_1
!  ---------------------------------

       else if ( Wavelength .gt. 300.0_fpk .and. Wavelength .lt. Limwav1 ) then

         trawl = .true. ; wc = 0
         do while (trawl .and. wc.lt.11 )
            wc = wc + 1
            if (  Wavelength .ge. vasilkov_wavs(wc) ) then
               if ( Wavelength .lt. vasilkov_wavs(wc+1) ) trawl = .false.
            endif
         enddo 
         wv1 = wc ; wv2 = wv1 + 1
         fv1 = ( vasilkov_wavs(wv2) - Wavelength ) * Wavdiff ; fv2 = 1.0_fpk - fv1 
         vas_chl_a = vasilkov_chl_coeff_a(wv1) * fv1 + vasilkov_chl_coeff_a(wv2) * fv2
         vas_chl_b = vasilkov_chl_coeff_b(wv1) * fv1 + vasilkov_chl_coeff_b(wv2) * fv2
         a_chl = vas_chl_a*(C**(-vas_chl_b)) ; a_ph  = C * a_chl
!         da_ph = a_chl*(1.0_fpk-vas_chl_b)

!  Between Wavlim_1 and up to Wavlim_2
!  -----------------------------------

       else if ( Wavelength .ge. LimWav1 .and. Wavelength .lt. LimWav2 .and.Gradfix ) then

!  Y1 and G1 are the C-abs value and the wavelength derivative at Wavlim_1 (Vasilkov egime)

         trawl = .true. ; wc = 0
         do while (trawl .and. wc.lt.11 )
            wc = wc + 1
            if (  LimWav1 .ge. vasilkov_wavs(wc) ) then
               if ( LimWav1 .lt. vasilkov_wavs(wc+1) ) trawl = .false.
            endif
         enddo 
         wv1 = wc ; wv2 = wv1 + 1
         fv1 = ( vasilkov_wavs(wv2) - LimWav1 ) * Wavdiff ; fv2 = 1.0_fpk - fv1 
         vas_chl_a = vasilkov_chl_coeff_a(wv1) * fv1 + vasilkov_chl_coeff_a(wv2) * fv2
         vas_chl_b = vasilkov_chl_coeff_b(wv1) * fv1 + vasilkov_chl_coeff_b(wv2) * fv2
         d_vas_chl_a = ( vasilkov_chl_coeff_a(wv2) - vasilkov_chl_coeff_a(wv1) ) * WavDiff
         d_vas_chl_b = ( vasilkov_chl_coeff_b(wv2) - vasilkov_chl_coeff_b(wv1) ) * WavDiff
         a_chl = vas_chl_a*(C**(-vas_chl_b)) ; y1  = C * a_chl
         y1  = C * a_chl
         g1 = y1 * ( (d_vas_chl_a/vas_chl_a) - d_vas_chl_b * Log(C) )
!         h1 = a_chl*(1.0_fpk-vas_chl_b)
!         k1 = ( g1 * ( 1.0_fpk-vas_chl_b) - d_vas_chl_b * y1 ) / C
 
!  Y2 and G2 are the C-abs value and the wavelength derivative at Wavlim_2 (Lee Regime)

         trawl = .true. ; wc = 0
         do while (trawl .and. wc.lt.33 )
            wc = wc + 1
            if (  LimWav2 .ge. lee_wavs(wc) ) then
               if ( LimWav2 .lt. lee_wavs(wc+1) ) trawl = .false.
            endif
         enddo
         wl1 = wc ; wl2 = wl1 + 1 
         fl1 = ( lee_wavs(wl2) - LimWav2 ) * Wavdiff ; fl2 = 1.0_fpk - fl1 
         lee_chl_a = lee_chl_coeff_a(wl1) * fl1 + lee_chl_coeff_a(wl2) * fl2
         lee_chl_b = lee_chl_coeff_b(wl1) * fl1 + lee_chl_coeff_b(wl2) * fl2
         d_lee_chl_a = ( lee_chl_coeff_a(wl2) - lee_chl_coeff_a(wl1) ) * Wavdiff
         d_lee_chl_b = ( lee_chl_coeff_b(wl2) - lee_chl_coeff_b(wl1) ) * WavDiff
         y2  = ( lee_chl_a + lee_chl_b * Loga_440 ) * a_440
         g2 = (d_lee_chl_a+d_lee_chl_b*log(a_440))*a_440
!         h2 = 0.65_fpk * ( y2 + lee_chl_b*a_440 ) / C
!         k2 = 0.65_fpk * ( g2 + d_lee_chl_b*a_440 ) / C

!  develop cubic fitting function to assign absorption

         x = LimWav2 - 400.0_fpk ; xsq = x * x
         ccon = ( (g1+g2)) / 4.0_fpk / x
         acon = ( (y1+y2) - 2.0_fpk * ccon * xsq ) / 2.0_fpk
         bcon = ( - (3.0_fpk* y1 - x*g1) + 3.0_fpk*acon + ccon * xsq ) / 2.0_fpk / x
         dcon = ( y2 - acon - bcon * x - ccon * xsq ) / x / xsq
         x = Wavelength - 400.0_fpk
         a_ph  = acon + x * ( bcon + x * ( ccon + dcon * x ) ) 

!         x = LimWav2 - 400.0_fpk ; xsq = x * x
!         ccon = ( (k1+k2)) / 4.0_fpk / x
!         acon = ( (h1+h2) - 2.0_fpk * ccon * xsq ) / 2.0_fpk
!         bcon = ( - (3.0_fpk* h1 - x*k1) + 3.0_fpk*acon + ccon * xsq ) / 2.0_fpk / x
!         dcon = ( h2 - acon - bcon * x - ccon * xsq ) / x / xsq
!         x = Wavelength - 400.0_fpk
!         da_ph  = acon + x * ( bcon + x * ( ccon + dcon * x ) ) 

!  Between Wavlim_2 and up to 720 nm
!  ---------------------------------

       else if ( Wavelength .ge. LimWav2 .and. Wavelength .lt. 720.0_fpk ) then

         trawl = .true. ; wc = 0
         do while (trawl .and. wc.lt.33 )
            wc = wc + 1
            if (  Wavelength .ge. lee_wavs(wc) ) then
               if ( Wavelength .lt. lee_wavs(wc+1) ) trawl = .false.
            endif
         enddo
         wl1 = wc ; wl2 = wl1 + 1 
         fl1 = ( lee_wavs(wl2) - Wavelength ) * Wavdiff ; fl2 = 1.0_fpk - fl1 
         lee_chl_a = lee_chl_coeff_a(wl1) * fl1 + lee_chl_coeff_a(wl2) * fl2
         lee_chl_b = lee_chl_coeff_b(wl1) * fl1 + lee_chl_coeff_b(wl2) * fl2
         a_ph  = ( lee_chl_a + lee_chl_b * Loga_440 ) * a_440
...
!  ------------
         ...
         lee_chl_a = lee_chl_coeff_a(33)
         lee_chl_b = lee_chl_coeff_b(33)
         a_ph  = ( lee_chl_a + lee_chl_b * Loga_440 ) * a_440
!         da_ph = 0.65_fpk * ( a_ph + lee_chl_b*a_440 ) / C

       endif

!  Here is an earlier attempt to fix this problem
!  ----------------------------------------------
...
!        Removed placeholder and inserted interpolated values
!        foQ=foQ_Int_1(J) 
!        write(77,'(2f8.3,f10.6)')  wl*1000.0_fpk, Log(C),foQ
!        R2=foQ*(b_tot/a_tot)
!        Ocean_Reflecs(J) = real(R2,fpk)
!     enddo
...
! This is the spectral shape
      ...
      data Effective_WCRef/ &
     1.000_fpk,1.000_fpk,1.000_fpk,1.000_fpk,0.950_fpk,0.900_fpk,0.700_fpk,0.550_fpk,0.500_fpk,0.450_fpk,&
     0.400_fpk,0.350_fpk,0.300_fpk,0.250_fpk,0.200_fpk,0.150_fpk,0.100_fpk,0.050_fpk,0.000_fpk,0.000_fpk,&
     0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,&
     0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk,0.000_fpk/

!  Local variables
!  ---------------

!  Single precision in the original

   integer   :: iwl, iref
   real(fpk) :: Wlb, WLP, Ref(39), wspd, wl, Ref_i, Rwc
...
!  Scale data for value of 0.22 in the midvisible.
   ...
   DO iref = 1,39
      Ref(iref) = 0.22_fpk * Effective_WCRef(iref)
   ENDDO
...
! (i.e. check for ws < 3.7) A Sayer 21 Feb 2017
   ...
   Wlb = 0.0_fpk
   IF (wspd .le. 9.25_fpk) THEN
      Wlb = 0.01_fpk*((3.18e-03_fpk)*((wspd-3.7_fpk)**3))
   ELSE IF (wspd .gt. 9.25_fpk) THEN
      Wlb = 0.01_fpk*((4.82e-04_fpk)*((wspd+1.8_fpk)**3))
   END IF
   IF (wspd .le. 3.7_fpk) THEN
      Wlb = 0.0_fpk
   END IF
...
!  Find data point, Linearly interpolate
   ...
   iwl   = 1+int((wl-0.2_fpk)/0.1_fpk)
   wlp   = 0.5_fpk+(iwl-1)*0.1_fpk
   Ref_i = Ref(iwl+1) + ( wl-wlp)/0.1_fpk*(Ref(iwl)-Ref(iwl+1))
   Rwc   = Wlb*Ref_i
...
!  I/O double precision. Local computations also now in double precision
...
!  Table information
   ...
   real(fpk) :: Logpigs(6), Lambdas(7), cossuns(6), lams(7), pigs(6), suns(6)
   real(fpk) :: FoQ_Table(17,13), fOQ_averaged(7,6,6)

   data suns / 0.0_fpk, 15.0_fpk, 30.0_fpk, 45.0_fpk, 60.0_fpk, 75.0_fpk /
   data pigs / 0.03_fpk, 0.1_fpk, 0.3_fpk, 1.0_fpk, 3.0_fpk, 10.0_fpk /
   data lams / 412.5_fpk, 442.5_fpk, 490.0_fpk, 510.0_fpk, 560.0_fpk, 620.0_fpk, 660.0_fpk /

!  help variables (all single precision)

   real(fpk) :: dtr, fw1, fw2, fs1, fs2, cszas(Maxszas)
   real(fpk) :: Wave, csza, LogC, lam, sun, pigc, fval, yspline(6), bbas(6), cbas(6), dbas(6), foQ_suns(6)
   ...
   do i = 1, 7 !lam
     do j = 1, 6 !sun
       do k = 1, 6 !pigc
         ...
         enddo
         fOQ_averaged(i,j1,k) = sum(FoQ_Table(1:17,1:13))/221.0_fpk
       enddo
     enddo
   enddo
   close(45)
...
!  Find boundaries
   ...
   Wave = real(Wavelength) * 1000.0_fpk ! Convert to [nm]
   if ( Wave.le.Lambdas(1) ) then
      w1 = 1 ; w2 = w1 + 1 ; fw1 = 1.0_fpk ; fw2 = 0.0_fpk
   else if ( Wave.ge.Lambdas(7) ) then
      w1 = 6 ; w2 = w1 + 1 ; fw1 = 0.0_fpk ; fw2 = 1.0_fpk
   else
      do i = 1, 6
         if ( Wave.gt.Lambdas(i).and.Wave.le.Lambdas(i+1)) w1 = i
      enddo
      w2 = w1 + 1 ; fw1 = (Lambdas(w2)-Wave)/(Lambdas(w2)-Lambdas(w1)) ; fw2 = 1.0_fpk - fw1
   endif
...
!      SUBROUTINE spline(x,y,n,yp1,ypn,y2)
   ...
   LogC = log(PigmentConc)
   do j = 1, 6 !sun
      do k = 1, 6 !pigc
         yspline(k) = fw1*foQ_averaged(w1,j,k) + fw2*foQ_averaged(w2,j,k) 
      enddo
      Call BSPLINE2(6,6,LogPigs,yspline,bbas,cbas,dbas)
      Call SEVAL2(6,6,LogC,LogPigs,yspline,bbas,cbas,dbas,foQ_suns(j))
   enddo
...
!  Solar angles
   ...
   do n = 1, nszas
      ...
      if ( csza.le.cossuns(1) ) then
         s1 = 1 ; s2 = s1 + 1 ; fs1 = 1.0_fpk ; fs2 = 0.0_fpk
      else if ( csza.ge.cossuns(6) ) then
         s1 = 5 ; s2 = s1 + 1 ; fs1 = 0.0_fpk ; fs2 = 1.0_fpk
      else
         do j = 1, 5
            if ( csza .gt.cossuns(j).and.csza.le.cossuns(j+1)) s1 = j
         enddo
         s2 = s1 + 1 ; fs1 = (cossuns(s2)-csza)/(cossuns(s2)-cossuns(s1)) ; fs2 = 1.0_fpk - fs1
      endif
...
!  Table information
   ...
   real(fpk) :: Logpigs(6), Lambdas(7), cossuns(6), cosnads(17), lams(7), pigs(6), suns(6), nads(17)
   real(fpk) :: FoQ_Table(17,13), fOQ_averaged(7,6,6), fOQ_averaged_2(7,6,6,17)

   data suns / 0.0_fpk, 15.0_fpk, 30.0_fpk, 45.0_fpk, 60.0_fpk, 75.0_fpk /
   data pigs / 0.03_fpk, 0.1_fpk, 0.3_fpk, 1.0_fpk, 3.0_fpk, 10.0_fpk    /
   data lams / 412.5_fpk, 442.5_fpk, 490.0_fpk, 510.0_fpk, 560.0_fpk, 620.0_fpk, 660.0_fpk /
   data nads /  1.078_fpk,  3.411_fpk,  6.289_fpk,  9.278_fpk, 12.300_fpk, 15.330_fpk, &
               18.370_fpk, 21.410_fpk, 24.450_fpk, 27.500_fpk, 30.540_fpk, 33.590_fpk, &
               36.640_fpk, 39.690_fpk, 42.730_fpk, 45.780_fpk, 48.830_fpk /

!  help variables (all single precision)

   real(fpk) :: fw1, fw2, fs1, fs2, fd1, fd2, yspline(6), bbas(6), cbas(6), dbas(6)
   real(fpk) :: Wave, LogC, C, cs, cd, lam, sun, pigc, fval, foQ_suns(6), foQ_nads(6,17)
   real(fpk) :: dtr, local_sine, local_cos, incident_angle, refrac_R_sp, foQ_1, foQ_2
   real(fpk) :: cstreams(Maxstreams), cszas(Maxszas), cvzas(Maxvzas)
...
!    -- refract the viewing angles
   ...
   do i = 1, nstreams
      local_cos  = streams(i)
      local_sine = sqrt ( 1.0_fpk - local_cos * local_cos )
      incident_angle = asin(local_sine/refrac_R)
      cstreams(i) = cos(incident_angle)
   enddo
   do i = 1, nvzas
      local_sine = sin(vzas(i)*dtr)
      incident_angle = asin(local_sine/refrac_R)
     ...
     do j = 1, 6
       do k = 1, 6
         ...
         do m = 1, 17
           ...
           fOQ_averaged_2(i,j1,k,m1) = sum(FoQ_Table(m,1:13))/13.0_fpk
         enddo
         fOQ_averaged(i,j1,k) = sum(FoQ_Table(1:17,1:13))/221.0_fpk
       enddo
     enddo
...
!  Find boundaries
   ...
   Wave = Wavelength * 1000.0_fpk ! Convert to [nm]
   if ( Wave.le.Lambdas(1) ) then
      w1 = 1 ; w2 = w1 + 1 ; fw1 = 1.0_fpk ; fw2 = 0.0_fpk
   else if ( Wave.ge.Lambdas(7) ) then
      w1 = 6 ; w2 = w1 + 1 ; fw1 = 0.0_fpk ; fw2 = 1.0_fpk
...
!      SUBROUTINE spline(x,y,n,yp1,ypn,y2)
   ...
   do j = 1, 6
      ...
      do m = 1, 17
         ...
         enddo
         Call BSPLINE2(6,6,LogPigs,yspline,bbas,cbas,dbas)
         Call SEVAL2(6,6,LogC,LogPigs,yspline,bbas,cbas,dbas,foQ_nads(j,m))
      enddo
   enddo
...
!  Solar angle loop
   ...
   do n = 1, nszas
      ...
      if ( cs.le.cossuns(1) ) then
         ...
         enddo
         s2 = s1 + 1 ; fs1 = (cossuns(s2)-cs)/(cossuns(s2)-cossuns(s1)) ; fs2 = 1.0_fpk - fs1
      endif
      FoQ_Int_1(n) = fs1 * foQ_suns(s1) + fs2 * foQ_suns(s2)
...
!            d1 = 5 ; d2 = d1 + 1 ; fd1 = 0.0 ; fd2 = 1.0   !  Wrong offset, produced glitches
         ...
         foQ_1 = fd1*foQ_nads(s1,d1) + fd2*foQ_nads(s1,d2) 
         foQ_2 = fd1*foQ_nads(s2,d1) + fd2*foQ_nads(s2,d2) 
         FoQ_Int_SV(n,i) = fs1 * foQ_1 + fs2 * foQ_2
      enddo
...
!    --  Add full array fOQ_Full(7,6,6,17,13), nazs(13) plus data statement
   ...
   real(fpk) :: Logpigs(6), Lambdas(7), cossuns(6), cosnads(17), lams(7), pigs(6), suns(6), nads(17), nazs(13)
   real(fpk) :: FoQ_Table(17,13), fOQ_averaged(7,6,6), fOQ_averaged_2(7,6,6,17), fOQ_Full(7,6,6,17,13)
   ...
   data nads /  1.078_fpk,  3.411_fpk,  6.289_fpk,  9.278_fpk, 12.300_fpk, 15.330_fpk, &
               18.370_fpk, 21.410_fpk, 24.450_fpk, 27.500_fpk, 30.540_fpk, 33.590_fpk, &
               36.640_fpk, 39.690_fpk, 42.730_fpk, 45.780_fpk, 48.830_fpk /
   data nazs / 0.0_fpk,  15.0_fpk,  30.0_fpk,  45.0_fpk,  60.0_fpk,  75.0_fpk, 90.0_fpk, &
                        105.0_fpk, 120.0_fpk, 135.0_fpk, 150.0_fpk, 165.0_fpk, 180.0_fpk /

!  Help variables (all single precision)
!    1/31/21. Version 2.8.3. Some new help variables

   real(fpk) :: fw1, fw2, fs1, fs2, fd1, fd2, fz1, fz2, fq1, fq2, yspline(6), bbas(6), cbas(6), dbas(6)
   real(fpk) :: Wave, LogC, C, cd, lam, sun, pigc, fval, foQ_suns(6), foQ_nads(6,17), foQ_nadazs(6,17,13)
   real(fpk) :: dtr, local_sine, local_cos, incident_angle, refrac_R_sp, foQ_1, foQ_2
   real(fpk) :: foQ_s1d1, foQ_s1d2, foQ_s2d1, foQ_s2d2
   real(fpk) :: cstreams(Maxstreams), cszas(Maxszas), cvzas(Maxvzas)

   integer   :: i, j, k, m, n, w1, w2, s1, s2, d1, d2, j1, m1, z, z1, z2, q1, q2
   integer   :: isza(Maxszas),istr(Maxstreams),ivza(Maxvzas),iazm(Maxazms)
   real(fpk) :: fsza(Maxszas),fstr(Maxstreams),fvza(Maxvzas),fazm(Maxazms)
   ...
   do j = 1, 6
      ...
      do m = 1, 17
         ...
         do z = 1, 13
            ...
            enddo
            Call BSPLINE2(6,6,LogPigs,yspline,bbas,cbas,dbas)
            Call SEVAL2(6,6,LogC,LogPigs,yspline,bbas,cbas,dbas,foQ_nadazs(j,m,z))
         enddo
      enddo
   enddo
...
!  Isotropy
      ...
      s1 = isza(n) ; s2 = s1 + 1 ; fs1 = fsza(n) ; fs2 = 1.0_fpk - fs1
      FoQ_Int_1(n) = fs1 * foQ_suns(s1) + fs2 * foQ_suns(s2)

!  Stream angles

      do i = 1, nstreams
         q1 = istr(i) ; q2 = q1 + 1 ; fq1 = fstr(i) ; fq2 = 1.0_fpk - fq1
...
!   -- 1/31/21. Version 2.8.3. Azimuth section is new
      ...
      do i = 1, nvzas
         d1 = ivza(i) ; d2 = d1 + 1 ; fd1 = fvza(i) ; fd2 = 1.0_fpk - fd1
         foQ_1 = fd1*foQ_nads(s1,d1) + fd2*foQ_nads(s1,d2)
         foQ_2 = fd1*foQ_nads(s2,d1) + fd2*foQ_nads(s2,d2)
         FoQ_Int_SV(n,i) = fs1 * foQ_1 + fs2 * foQ_2
         do j = 1, nazms
            z1 = iazm(j) ; z2 = z1 + 1 ; fz1 = fazm(j) ; fz2 = 1.0_fpk - fz1
            ...
            FoQ_Int_SVA(n,i,j) = fs1 * foQ_1 + fs2 * foQ_2
         enddo
      enddo
...
!    --  Add full array fOQ_Full(7,6,6,17,13), nazs(13) plus data statement
   ...
   real(fpk) :: Logpigs(6), Lambdas(7), cossuns(6), cosnads(17), lams(7), pigs(6), suns(6), nads(17), nazs(13)
   real(fpk) :: FoQ_Table(17,13), fOQ_Full(7,6,6,17,13)
...
!    1/31/21, Version 2.8.3. Some new help variables
   ...
   real(fpk) :: fw1, fw2, fs1, fs2, fd1, fd2, fz1, fz2, fq1, fq2, yspline(6), bbas(6), cbas(6), dbas(6)
   real(fpk) :: Wave, LogC, C, cd, lam, sun, pigc, fval, foQ_nadazs(6,17,13)
   real(fpk) :: dtr, local_sine, local_cos, incident_angle, refrac_R_sp, foQ_1, foQ_2
   real(fpk) :: foQ_s1d1, foQ_s1d2, foQ_s2d1, foQ_s2d2, foQ_s1q1, foQ_s1q2, foQ_s2q1, foQ_s2q2
   real(fpk) :: cstreams(Maxstreams), cszas(Maxszas), cvzas(Maxvzas)

   integer   :: i, j, k, m, n, w1, w2, s1, s2, d1, d2, j1, m1, z, z1, z2, q1, q2
   integer   :: isza(Maxszas),istr(Maxstreams),ivza(Maxvzas),iaqh(Maxaqhalf)
   real(fpk) :: fsza(Maxszas),fstr(Maxstreams),fvza(Maxvzas),faqh(Maxaqhalf)
...
!  Find boundaries
   ...
   Wave = Wavelength * 1000.0 ! Convert to [nm]
   if ( Wave.le.Lambdas(1) ) then
      w1 = 1 ; w2 = w1 + 1 ; fw1 = 1.0_fpk ; fw2 = 0.0_fpk
   else if ( Wave.ge.Lambdas(7) ) then
      w1 = 6 ; w2 = w1 + 1 ; fw1 = 0.0_fpk ; fw2 = 1.0_fpk
...
!   -- 1/31/21, Version 2.8.3. Azimuth section is new
      ...
      do i = 1, nstreams
         q1 = istr(i) ; q2 = q1 + 1 ; fq1 = fstr(i) ; fq2 = 1.0_fpk - fq1
         do j = 1, naqhalf
            z1 = iaqh(j) ; z2 = z1 + 1 ; fz1 = faqh(j) ; fz2 = 1.0_fpk - fz1
            ...
            FoQ_Int_SDQ(n,i,j) = fs1 * foQ_1 + fs2 * foQ_2
         enddo
      enddo
...
!   -- 1/31/21, Version 2.8.3. Azimuth section is new
      ...
      do i = 1, nvzas
         ...
         do j = 1, naqhalf
            ...
            foQ_1 = fd1*foQ_s1d1 + fd2*foQ_s1d2 
            foQ_2 = fd1*foQ_s2d1 + fd2*foQ_s2d2 
            FoQ_Int_SVQ(n,i,j) = fs1 * foQ_1 + fs2 * foQ_2
         enddo
      enddo
...
!  start
!   Ta = 0.0_fpk ; dtr = acos(-1.0_fpk)/180.0_fpk
!   do j = 1, nTa_szas
...
!      w1 = nTa_wavs-1 ; w2 = w1 + 1 ; fw1 = 0.0_fpk ; fw2 = 1.0_fpk
!   else
!      do i = 1, nTa_wavs-1
!         if ( Wave.gt.Ta_wavs(i).and.Wave.le.Ta_wavs(i+1)) w1 = i
!      enddo
!      w2 = w1 + 1 ; fw1 = (Ta_wavs(w2)-Wave)/(Ta_wavs(w2)-Ta_wavs(w1)) ; fw2 = 1.0_fpk - fw1
!   endif
!   if ( mu0.le.cosTa_szas(1) ) then
!      s1 = 1 ; s2 = s1 + 1 ; fs1 = 1.0_fpk ; fs2 = 0.0_fpk
!   else if ( mu0.ge.cosTa_szas(nTa_szas) ) then
!      s1 = nTa_szas-1 ; s2 = s1 + 1 ; fs1 = 0.0_fpk ; fs2 = 1.0_fpk
!   else
!      do j = 1, nTa_szas-1
!         if ( mu0 .gt.cosTa_szas(j).and.mu0.le.cosTa_szas(j+1)) s1 = j
!      enddo
!      s2 = s1 + 1 ; fs1 = (cosTa_szas(s2)-mu0)/(cosTa_szas(s2)-cosTa_szas(s1)) ; fs2 = 1.0_fpk - fs1
!   endif
...
!  initialize
      ...
      Fs755 = 0.0_fpk
      PI = acos(-1.0_fpk) ; D2R = PI / 180.0_fpk
      verbose = .false. ; lunit = 4555

!  Grids

      do i = 1, NLAT_FLUO_FILE
          lat_data(i) = 90.0_fpk - real((i-1),fpk)*0.5_fpk
      enddo
      do j = 1, NLON_FLUO_FILE
          lon_data(j) = -180.0_fpk + 0.5_fpk * real((j-1),fpk)
      enddo
...
function average_solar_cosine(lat, doy, pi, d2r) result(avmu)
        ...
        avmu = 1.0d0/PI * (sin(lat*D2R)*sin(dec)*H + cos(lat*D2R)*cos(dec)*sin(H))
