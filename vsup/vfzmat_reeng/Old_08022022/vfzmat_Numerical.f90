...
!   "vfzmat" Supplement for VLIDORT, arranged 9/19/16
      ...
      DOUBLE PRECISION, PARAMETER :: ONE = 1.0D0, ZERO = 0.0D0,  ONEP5 = 1.5D0
      DOUBLE PRECISION, PARAMETER :: TWO = 2.0D0, THREE = 3.0D0, FOUR = 4.0D0
      DOUBLE PRECISION, PARAMETER :: QUARTER = 0.25D0, HALF = 0.5D0
      DOUBLE PRECISION, PARAMETER :: DEG_TO_RAD = 1.7453292519943D-02
      DOUBLE PRECISION, PARAMETER :: PIE = 180.0D0*DEG_TO_RAD
