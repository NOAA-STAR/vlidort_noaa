...
subroutine vfzmat_Pre_Master &
   ( max_geoms, max_szas, max_vzas, max_azms, dtr,                     & ! Input Dimensions (VLIDORT)
     ...
     ncoeffs, nstokes, n_QuadAngles, n_geoms, n_szas, n_vzas, n_azms,  & ! Input Control integers
     Lattice_offsets, Doublet_offsets, szas, vzas, azms, Obsgeoms,     & ! Input Offsets and Geometries
