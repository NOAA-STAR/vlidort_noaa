...
!  Number of computational streams in the half-space
      ...
      INTEGER, PARAMETER :: MAXSTREAMS = 6

!  Maximum number of computational layers

!XIONG      INTEGER, PARAMETER :: MAXLAYERS = 26 !49  
      INTEGER, PARAMETER :: MAXLAYERS = 51!115
...
!     -- Kokhanovsky and Breon, IEEE GeoScience & Remote Sensing Letters, Vol
!     9(5), 928-932 (2012)
!     -- First introduced to VLIDORT, 18 November 2020.

      INTEGER, PARAMETER :: SNOWBRDF_IDX         = 19

!  3/11/22, Version 2.8.5. Second Analytical Model for Snow BRDF.
!     -- A. Ding et al, Remote Sensing, 11, 2019.

      INTEGER, PARAMETER :: SNOWRTS_IDX         = 20


!  1/31/21, Version 2.8.3. Maximum index
!    -- Revised to take into account New snow brdf index.

      INTEGER, PARAMETER :: MAXBRDF_IDX = SNOWRTS_IDX
