...
!mick fix 8/15/2022 - replaced "N" with "N1" in PCON on RHS of EQ below
...
!  Enhancement # 13, 6/27/16
            ...
            PCON(IROW,N,1:N_COLUMNWFS) = T_DELT_DISORDS(I,N1) * PCON(IROW,N1,1:N_COLUMNWFS) &
...
!mick fix 8/15/2022 - replaced "N" with "N1" in NCON on RHS of EQ below
...
!  Enhancement # 14, 6/27/16
              NCON(IROW,N,1:N_COLUMNWFS) =   T_DELT_DISORDS(I,N1) * NCON(IROW,N1,1:N_COLUMNWFS) &
