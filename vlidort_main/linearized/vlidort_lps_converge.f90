...
!  Everything public
      ...
      SUBROUTINE VLIDORT_LPS_CONVERGE ( AWI, &
                    ...
                    DO UT = 1, N_USER_LEVELS
                      DO I = 1, N_OUT_STREAMS
                        DO UA = 1, LOCAL_N_USERAZM
                          V = VZA_OFFSETS(IBEAM,I) + UA
                          DO O1 = 1, NSTOKES
                            !CALL TP23E (AWI,FOURIER,Q,N,UT,V,O1,W,PROFILEWF,PROFILEWF_SS)
                  ...
                  DO UT = 1, N_USER_LEVELS
                    DO I = 1, N_OUT_STREAMS
                      DO UA = 1, LOCAL_N_USERAZM
                        V = VZA_OFFSETS(IBEAM,I) + UA
                        DO O1 = 1, NSTOKES
                          !CALL TP23F (AWI,FOURIER,Q,N,UT,V,O1,PROFILEWF,PROFILEWF_DB)
                  ...
                  DO IDIR = 1, N_DIRECTIONS
                    ...
                    DO UT = 1, N_USER_LEVELS
                      DO I = 1, N_OUT_STREAMS
                        V = VZA_OFFSETS(IBEAM,I) + UA
                        DO O1 = 1, NSTOKES
                          !CALL TP23G (AWI,FOURIER,Q,N,UT,I,IBEAM,V,O1,W,PROFILEWF,PROFILEWF_F)
                          VLIDORT_LinOut%Prof%TS_PROFILEWF(Q,N,UT,V,O1,W) = &
...
!
      ...
      SUBROUTINE VLIDORT_LPS_CONVERGE_DOUBLET ( AWI, &
        DO_FOCORR, DO_FOCORR_ALONE, DO_UPWELLING, DO_NO_AZIMUTH, DO_DBCORRECTION,     & ! Input flags
        DO_PROFILE_LINEARIZATION, DO_SURFACE_LINEARIZATION, DO_LAMBERTIAN_SURFACE,    & ! Input flags
        IBEAM, FOURIER, NSTOKES, NLAYERS, N_OUT_STREAMS, N_USER_LEVELS, N_DIRECTIONS, & ! Input control numbers
        LAYER_VARY_FLAG, LAYER_VARY_NUMBER, N_SURFACE_WFS, N_SLEAVE_WFS,              & ! Input linearization control
...
!
      ...
      SUBROUTINE VLIDORT_LPS_CONVERGE_OBSGEO ( AWI, &
        DO_FOCORR, DO_FOCORR_ALONE, DO_UPWELLING, DO_NO_AZIMUTH, DO_DBCORRECTION,  & ! Input flags
        DO_PROFILE_LINEARIZATION, DO_SURFACE_LINEARIZATION, DO_LAMBERTIAN_SURFACE, & ! Input flags
              ...
              IF ( LAYER_VARY_FLAG(N) ) THEN
                DO Q = 1, LAYER_VARY_NUMBER(N)
                  DO IDIR = 1, N_DIRECTIONS
                    ...
                    DO UT = 1, N_USER_LEVELS
                      DO O1 = 1, NSTOKES
                        !CALL TP23E2 (AWI,FOURIER,Q,N,UT,IB,O1,W,PROFILEWF,PROFILEWF_SS)
            ...
            DO N = 1, NLAYERS
              IF ( LAYER_VARY_FLAG(N) ) THEN
                DO Q = 1, LAYER_VARY_NUMBER(N)
                  DO UT = 1, N_USER_LEVELS
                     DO O1 = 1, NSTOKES
                       !CALL TP23F2 (AWI,FOURIER,Q,N,UT,IB,O1,PROFILEWF,PROFILEWF_DB)
            ...
            IF ( LAYER_VARY_FLAG(N) ) THEN
              DO Q = 1, LAYER_VARY_NUMBER(N)
                DO IDIR = 1, N_DIRECTIONS
                  ...
                  DO UT = 1, N_USER_LEVELS
                    DO O1 = 1, NSTOKES
                      !CALL TP23G2 (AWI,FOURIER,Q,N,UT,LUM,IB,O1,W,PROFILEWF,PROFILEWF_F)
                      VLIDORT_LinOut%Prof%TS_PROFILEWF(Q,N,UT,IB,O1,W) = &
