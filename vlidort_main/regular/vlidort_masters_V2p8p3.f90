...
!     ** ALBMED output for TOA illumination, TRNMED output for BOA illumination
...
!  Misc. help
      ...
      INTEGER ::          OFF, O1, UA, UM, IB, G, G1, G2, L, UTA, LUM, LUA, V, NMOMS, NM
...
!mick mod 9/22/2022 - added input variable "ATMOS_INDEX" to argument list
         ...
         CALL VLIDORT_FOURIER ( ATMOS_INDEX, FOURIER, DO_FOURIER0_NSTOKES2, &
...
!
      ...
      SUBROUTINE VLIDORT_FOURIER ( AWI, FOURIER, DO_FOURIER0_NSTOKES2, &
...
! 566  CONTINUE. removed, Version 2.8
