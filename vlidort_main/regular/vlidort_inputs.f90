...
!  Mick Mod 9/22/22. Add Wavelength Index as a Diagnostic

      VLIDORT_FixIn%Optical%TS_ATMOS_WAVELENGTH      = ZERO
      VLIDORT_FixIn%Optical%TS_ATMOS_INDEX           = 0
...
!  ===================================================
!mick fix 9/12/2022 - initialize CONTRIBS_SS

      VLIDORT_Sup%SS%TS_STOKES_SS   = ZERO
      VLIDORT_Sup%SS%TS_STOKES_DB   = ZERO
      VLIDORT_Sup%SS%TS_CONTRIBS_SS = ZERO
...
!  4/11/22. Condition also applies for Doublet.
!mick fix 8/4/2022 - replaced "OR" with "AND" in IF condition
