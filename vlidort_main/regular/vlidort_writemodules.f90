...
!
      ...
      SUBROUTINE VLIDORT_WRITE_STD_INPUT ( DO_DEBUG_WRITE, &
        ...
        HEIGHT_GRID, PRESSURE_GRID, TEMPERATURE_GRID, FINEGRID, GEOMETRY_SPECHEIGHT, ATMOS_WAVELENGTH, ATMOS_INDEX, & ! Atmos inputs
...
!  Open output file
!mick mod 9/22/2022 - added "ATMOS_INDEX" string to output file name

      OUTUNIT = 101
      !OPEN (OUTUNIT,file = 'VLIDORT_WRITE_STD_INPUT.dbg',status = 'replace')
      WRITE(AI,'(i4.4)') ATMOS_INDEX
      OPEN (OUTUNIT,file = 'VLIDORT_WRITE_STD_INPUT_'//AI//'.dbg',status = 'replace')
...
!  New section for 2.8 code. F-Matrices
      ...
      WRITE(OUTUNIT,DWFI)  'ATMOS_INDEX       = ',ATMOS_INDEX
...
!
      ...
      SUBROUTINE VLIDORT_WRITE_SUP_BRDF_INPUT ( ATMOS_INDEX, &
...
!mick mod 9/22/2022 - added "ATMOS_INDEX" string to output file name
      ...
      WRITE(AI,'(i4.4)') ATMOS_INDEX
      OPEN (OUTUNIT,file = 'VLIDORT_WRITE_SUP_BRDF_INPUT_'//AI//'.dbg',status = 'replace')
...
!
      ...
      SUBROUTINE VLIDORT_WRITE_SUP_SS_INPUT ( ATMOS_INDEX, &
...
!mick mod 9/22/2022 - added "ATMOS_INDEX" string to output file name
      ...
      WRITE(AI,'(i4.4)') ATMOS_INDEX
      OPEN (OUTUNIT,file = 'VLIDORT_WRITE_SUP_SS_INPUT_'//AI//'.dbg',status = 'replace')
...
!
      ...
      SUBROUTINE VLIDORT_WRITE_SUP_SLEAVE_INPUT ( ATMOS_INDEX, &
...
!mick mod 9/22/2022 - added "ATMOS_INDEX" string to output file name
      ...
      WRITE(AI,'(i4.4)') ATMOS_INDEX
      OPEN (OUTUNIT,file = 'VLIDORT_WRITE_SUP_SLEAVE_INPUT_'//AI//'.dbg',status = 'replace')
