...
!
      ...
      SUBROUTINE WHOLELAYER_STERM_UP ( AWI, &
        ...
        DO LUM = 1, N_PPSTREAMS
           ...
           DO O1 = 1, NSTOKES
              ...
              DO K = 1, K_REAL(N)
                 ...
                 !CALL TP31A1 (AWI,N,UM,LUM,K,O1,LCON,MCON,UHOM_UPDN,UHOM_UPUP,&
              ...
              !CALL TP31A2 (AWI,N,UM,O1,H_R,H_CR,LAYERSOURCE)
           ENDDO
        ENDDO
      ...
      IF ( DO_CLASSICAL_SOLUTION ) THEN
         DO LUM = 1, N_PPSTREAMS
            ...
            DO O1 = 1, NSTOKES
               ...
               !CALL TP31A3 (AWI,N,UM,LUM,IB,O1,UPAR_UP_2,EMULT_UP,LAYERSOURCE)
            ENDDO
         ENDDO
      ENDIF
...
!               ENDDO
               ...
               PMULT_UD(K,UM,N) = SD
               PMULT_UU(K,UM,N) = SU
               !CALL TP31A4 (AWI,N,UM,K,SD,SU,ATERM_SAVE,BTERM_SAVE)
               do O1 = 1, NSTOKES
...
!    -- 1/31/21. Version 2.8.3. Use post-processing masks.
      ...
      DO LUM = 1, N_PPSTREAMS
         ...
         DO O1 = 1, NSTOKES
            ...
            !CALL TP31A5 (AWI,N,UM,LUM,IB,O1,UPAR_UP_1,EMULT_UP)
         ENDDO
      ENDDO
