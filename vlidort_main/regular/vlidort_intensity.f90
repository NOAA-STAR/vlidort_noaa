...
!  1/31/21. Version 2.8.3.  ==> Convergence routines no longer in this list
      ...
      SUBROUTINE VLIDORT_UPUSER_INTENSITY ( AWI, & 
...
!    -- 1/31/21. Version 2.8.3.  Use post-processing mask system (N_PPSTREAMS, PPSTREAM_MASK).
            ...
            DO LUM = 1, N_PPSTREAMS
               ...
               DO O1 = 1, NSTOKES
                  ...
                  ENDIF
                  !CALL TP7A (AWI,N,NC,UM,O1,LAYER_SOURCE,T_DELT_USERM,CUMSOURCE_UP)
...
!    -- 1/31/21. Version 2.8.3.  Use post-processing mask system (N_PPSTREAMS, PPSTREAM_MASK).
            ...
            DO LUM = 1, N_PPSTREAMS
               ...
               DO O1 = 1, NSTOKES
                  ...
                  !CALL TP7B1 (AWI,UTA,UM,IBEAM,UT,NC,O1,FLUX_MULTIPLIER,&
...
!                  endif                                              ! FD
                  !CALL TP7B2 (AWI,UTA,UM,IBEAM,NC,O1,FLUX_MULTIPLIER,CUMSOURCE_UP,STOKES_F)
                ENDDO
             ENDDO
          ENDIF
...
!
      ...
      SUBROUTINE VLIDORT_DNUSER_INTENSITY ( AWI, &
...
!    -- 1/31/21. Version 2.8.3.  Use post-processing mask system (N_PPSTREAMS, PPSTREAM_MASK).
            ...
            DO LUM = 1, N_PPSTREAMS
               ...
               DO O1 = 1, NSTOKES
                  ...
                  !CALL TP7D1 (AWI,UTA,UM,IBEAM,UT,NC,O1,FLUX_MULTIPLIER,&
