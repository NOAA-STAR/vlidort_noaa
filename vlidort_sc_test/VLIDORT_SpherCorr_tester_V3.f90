...
! ###################################################################
      ...
      PROGRAM VLIDORT_SPHERCORR_TESTER_V3
...
!  11/28/22. Version 2.8.3 Upgrade. Single call, instead of 3 separate calls.
      ...
      CALL SPHERICITY_CORRECTION_MASTER ( do_debug_input,                   &
      ...
      if ( .not. Twilight_Flag ) then
        ...
        DO iv = 1,NVZA
          ...
          write(701,155) igeo,sza_set(is),vza_set(iv),raa_set(ia),'  I  ',&
              ...
              100.0_fpk*(1.0_fpk-(MS_STOKES_SPHERCORR(1,igeo)/MS_STOKES_BOAGEOM(1,igeo))),&
              100.0_fpk*(1.0_fpk-(STOKES_SPHERCORR(1,igeo)/STOKES_BOAGEOM(1,igeo)))
        ENDDO ; ENDDO ; ENDDO
        ...
        if (nstokes.gt.1) then
          ...
          DO iv = 1,NVZA
            ...
            write(701,155) igeo,sza_set(is),vza_set(iv),raa_set(ia),'  Q  ',&
                ...
                100.0_fpk*(1.0_fpk-(MS_STOKES_SPHERCORR(2,igeo)/MS_STOKES_BOAGEOM(2,igeo))),&
                100.0_fpk*(1.0_fpk-(STOKES_SPHERCORR(2,igeo)/STOKES_BOAGEOM(2,igeo)))
          ENDDO ; ENDDO ; ENDDO
        endif
          ...
          DO iv = 1,NVZA
            ...
            if (abs(STOKES_BOAGEOM(3,igeo)) .gt. ZERO) then
              write(701,155) igeo,sza_set(is),vza_set(iv),raa_set(ia),'  U  ',&
                  ...
                  100.0_fpk*(1.0_fpk-(MS_STOKES_SPHERCORR(3,igeo)/MS_STOKES_BOAGEOM(3,igeo))),&
                  100.0_fpk*(1.0_fpk-(STOKES_SPHERCORR(3,igeo)/STOKES_BOAGEOM(3,igeo)))
            else
              write(701,155) igeo,sza_set(is),vza_set(iv),raa_set(ia),'  U  ', &
                  FO_STOKES_BOAGEOM(3,igeo), MS_STOKES_BOAGEOM(3,igeo), STOKES_BOAGEOM(3,igeo),&
                  MS_STOKES_SPHERCORR(3,igeo), STOKES_SPHERCORR(3,igeo),&
...
!  Finish
      ...
      write(*,'(/a/)') 'Main program VLIDORT_SPHERCORR_TESTER_V3 finished successfully'

      END PROGRAM VLIDORT_SPHERCORR_TESTER_V3
